...
/* harmony import */ var _dasboard_dasboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dasboard/dasboard.component */ "./src/app/dasboard/dasboard.component.ts");
...
/* harmony import */ var _scans_scans_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scans/scans.component */ "./src/app/scans/scans.component.ts");
...
var routes = [
    ...
    { path: 'dashboard', component: _dasboard_dasboard_component__WEBPACK_IMPORTED_MODULE_3__["DasboardComponent"] },
    { path: 'scans', component: _scans_scans_component__WEBPACK_IMPORTED_MODULE_5__["ScansComponent"] },
...
/* harmony import */ var _scans_scans_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./scans/scans.component */ "./src/app/scans/scans.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _scans_scans_component__WEBPACK_IMPORTED_MODULE_10__["ScansComponent"],
...
var DasboardComponent = /** @class */ (function () {
    function DasboardComponent(heroService) {
    ...
    DasboardComponent.prototype.getHeroes = function () {
        var _this = this;
...
var HeroService = /** @class */ (function () {
    function HeroService(http, messageService) {
        ...
        this.urlTest = 'http://cartplus-api.loc/api/test/index';
        this.urlTestPost = 'http://cartplus-api.loc/api/test/detail';
    ...
    HeroService.prototype.getHeroes = function () {
        ...
        return this.http.get(this.urlTest)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (heroes) { return _this.log("fetched heroes"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getHeroes', [])));
    };
    HeroService.prototype.getApi = function () {
        var _this = this;
        // TODO: send the message _after_ fetching the heroes
        return this.http.get(this.urlTest)
    ...
    HeroService.prototype.postApi = function (hero) {
        var _this = this;
    ...
    HeroService.prototype.addHero = function (hero) {
        var _this = this;
        return this.http.post(this.urlTestPost, hero, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (hero) { return _this.log("added hero w/ id=" + hero.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('addHero')));
    };
    HeroService.prototype.loginPolan = function () {
        var data = { email: "duc4@runsystem.net",
            password: "123321",
            os_type: 1 };
        return this.http.post(this.urlLoginPolan, data, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (data) { return data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('addHero')));
    };
...
var HeroesComponent = /** @class */ (function () {
    function HeroesComponent(http, heroService) {
        this.http = http;
        this.heroService = heroService;
        this.heroService.loginPolan().subscribe(function (data) { return console.log(data); });
    ...
    HeroesComponent.prototype.getPostApi = function (hero) {
        this.heroService.postApi(hero).subscribe(function (data) {
            console.log(data);
        });
    };
    ...
    HeroesComponent.prototype.getApt = function () {
        var urlApt = 'http://cartplus-api.loc/api/category/list.json?client_id=1';
        // test api
        this.http.get(urlApt).subscribe(function (data) {
            console.log(data);
        }, function (err) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(loginService, localtion, router) {
        this.loginService = loginService;
        this.localtion = localtion;
        this.router = router;
        this.fagLg = false;
        this.email = 'duc4@runsystem.net';
    ...
    LoginComponent.prototype.onSubmit = function (formLogin) {
        var _this = this;
        var body = formLogin.value;
        this.loginService.loginPolan(body).subscribe(function (data) { return _this.readData(data); }, function (error) { return console.log('oops', error.error.data); });
    };
...
/***/ "./src/app/scans/scans.component.css":
/*!*******************************************!*\
  !*** ./src/app/scans/scans.component.css ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./src/app/scans/scans.component.html":
/*!********************************************!*\
  !*** ./src/app/scans/scans.component.html ***!
  \********************************************/
/*! no static exports found */
...
/*!******************************************!*\
  !*** ./src/app/scans/scans.component.ts ***!
  \******************************************/
/*! exports provided: ScansComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScansComponent", function() { return ScansComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_pwa_local_storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-pwa/local-storage */ "./node_modules/@ngx-pwa/local-storage/fesm5/local-storage.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ScansComponent = /** @class */ (function () {
    function ScansComponent(localStorage) {
        this.localStorage = localStorage;
    }
    ScansComponent.prototype.ngOnInit = function () {
        localStorage.setItem("username", "John");
        if (localStorage.getItem("LocalData") == "undefined" || localStorage.getItem("LocalData") == null) {
            localStorage.setItem("LocalData", JSON.stringify([]));
        }
    };
    ScansComponent.prototype.scan = function () {
    ...
    ScansComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-scans',
            template: __webpack_require__(/*! ./scans.component.html */ "./src/app/scans/scans.component.html"),
            styles: [__webpack_require__(/*! ./scans.component.css */ "./src/app/scans/scans.component.css")]
        }),
        __metadata("design:paramtypes", [_ngx_pwa_local_storage__WEBPACK_IMPORTED_MODULE_1__["LocalStorage"]])
    ], ScansComponent);
    return ScansComponent;
}());
...
module.exports = __webpack_require__(/*! D:\Source2018\app-cordova\source-code\src\main.ts */"./src/main.ts");
